...
import { RefreshCw, Plus, Edit, Trash2, Search, Briefcase } from 'lucide-react';
...
export default function PayrollBpjsTenagakerjaPage() {
    ...
    const handleCreate = () => {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                try {
                    await apiClient.post('/payroll/bpjs-tenagakerja', result.value);
    ...
    const handleEdit = (item: BpjsTkItem) => {
        Swal.fire({
            title: 'Edit BPJS Tenagakerja',
            html: `
                <div class="flex flex-col gap-3 text-left">
            ...
            if (result.isConfirmed) {
                try {
                    await apiClient.put(`/payroll/bpjs-tenagakerja/${item.kode_bpjs_tk}`, result.value);
    ...
    return (
        <MainLayout>
            <PageBreadcrumb pageTitle="BPJS Tenagakerja" />
