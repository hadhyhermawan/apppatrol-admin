...
type TurlalinItem = {
    ...
    nama_guard_masuk?: string | null;
    nama_guard_keluar?: string | null;
};

function CetakLaporanTurlalinContent() {
                ...
                <div id="print-area">
                    ...
                    <div className="flex mb-8 border-b-2 border-gray-800 pb-6 items-center justify-between">
                        ...
                        <div className="text-right">
                            <h2 className="text-xl font-bold text-blue-800 uppercase tracking-widest bg-blue-50 px-4 py-1 rounded-full border border-blue-200 inline-block">Pengaturan Lalu Lintas</h2>
                    ...
                    <div className="mb-6">
                        <h3 className="text-lg font-bold text-gray-900 mb-1">Riwayat Pengaturan Lalu Lintas</h3>
                    ...
                    <table className="w-full text-xs text-left align-middle border-collapse border border-gray-300">
                        <thead className="bg-gray-100 text-gray-900 border-b-2 border-gray-400">
                            <tr>
                                ...
                                <th className="px-3 py-2 border border-gray-300 w-[15%] font-semibold">Waktu Masuk / Keluar</th>
                                <th className="px-3 py-2 border border-gray-300 w-[15%] font-semibold">Nomor Polisi</th>
                                <th className="px-3 py-2 border border-gray-300 w-[20%] font-semibold">Petugas Bertugas</th>
                                <th className="px-3 py-2 border border-gray-300 w-[30%] font-semibold">Keterangan</th>
                                ...
                                <tr key={item.id} className={key % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                                    ...
                                    <td className="px-3 py-3 border border-gray-300 my-no-break align-top">
                                        <div className="flex flex-col gap-1">
                                            <div>
                                                <span className="text-[10px] uppercase font-bold text-green-700 bg-green-50 px-1 py-0.5 rounded border border-green-200">IN</span>
                                                <div className="font-semibold text-gray-900 mt-0.5 whitespace-nowrap">
                                                    {item.jam_masuk ? new Date(item.jam_masuk).toLocaleDateString('id-ID', { day: '2-digit', month: 'short', year: 'numeric' }) : '-'}
                                                </div>
                                            ...
                                            <div className="mt-2 pt-2 border-t border-gray-200 border-dashed">
                                                <span className="text-[10px] uppercase font-bold text-red-700 bg-red-50 px-1 py-0.5 rounded border border-red-200">OUT</span>
                                                <div className="font-semibold text-gray-900 mt-0.5 whitespace-nowrap">
                                                    {item.jam_keluar ? new Date(item.jam_keluar).toLocaleDateString('id-ID', { day: '2-digit', month: 'short', year: 'numeric' }) : '-'}
                                                </div>
                                                <div className="text-[10px] text-gray-600 font-mono tracking-tighter whitespace-nowrap">
                                    ...
                                    <td className="px-3 py-3 border border-gray-300 my-no-break align-top">
                                        <div className="font-bold text-gray-900 leading-tight uppercase whitespace-nowrap">{item.nomor_polisi}</div>
                                    </td>
                                    <td className="px-3 py-3 border border-gray-300 my-no-break align-top">
                                        <div className="flex flex-col gap-3">
                                            <div>
                                                <div className="text-[10px] text-gray-500 uppercase tracking-wider mb-0.5 border-b border-gray-200 max-w-fit">Petugas Masuk</div>
                                                <div className="font-semibold text-gray-900 leading-tight">{item.nama_guard_masuk || '-'}</div>
                                            </div>
                                            {item.nama_guard_keluar && (
                                                <div>
                                                    <div className="text-[10px] text-gray-500 uppercase tracking-wider mb-0.5 border-b border-gray-200 max-w-fit">Petugas Keluar</div>
                                                    <div className="font-semibold text-gray-900 leading-tight">{item.nama_guard_keluar}</div>
                                                </div>
                                            )}
                                        </div>
                                    </td>
                                    <td className="px-3 py-3 border border-gray-300 my-no-break align-top">
                                        <p className="whitespace-pre-wrap text-gray-700 leading-relaxed max-w-[400px]">
                                            {item.keterangan || '-'}
                                        </p>
                                    </td>
                                    <td className="px-3 py-3 border border-gray-300 text-center my-no-break align-top">
                                        <div className="flex flex-col gap-2 items-center">
                                            ...
                                            ) : (item.jam_keluar && <span className="text-gray-300 italic text-[10px] pt-2 border-t border-gray-100 w-full">No Photo OUT</span>)}
                                        </div>
                                    </td>
                                </tr>
                            ))}
