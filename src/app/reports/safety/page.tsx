...
function LaporanSafetyPage() {
    ...
    return (
        <MainLayout>
            <PageBreadcrumb pageTitle="Laporan Safety Briefing" />
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/[0.03] sm:p-6 mb-8">
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="flex gap-3">
                        ...
                        {isPrinting && (
                            <iframe
                                src={`/reports/safety/cetak?startDate=${dateStart}&endDate=${dateEnd}&cabang=${filterCabang}&vendorId=${filterVendor}&search=${searchTerm}`}
                    ...
                    <table className="w-full table-auto">
                        <thead>
                            <tr className="bg-gray-100 text-left dark:bg-gray-800">
                                ...
                                <th className="min-w-[200px] px-4 py-4 font-medium text-black dark:text-white">Waktu Briefing</th>
                                <th className="min-w-[200px] px-4 py-4 font-medium text-black dark:text-white">Pimpinan / Pemateri</th>
                                <th className="min-w-[150px] px-4 py-4 font-medium text-black dark:text-white">Shift</th>
                                <th className="min-w-[300px] px-4 py-4 font-medium text-black dark:text-white">Materi / Keterangan</th>
                                    ...
                                    <tr key={item.id} className="border-b border-stroke dark:border-strokedark hover:bg-gray-50 dark:hover:bg-meta-4/20">
                                        ...
                                        <td className="px-4 py-4">
                                            <div className="flex flex-col">
                                                <h5 className="font-bold text-black dark:text-white text-sm">{item.nama_karyawan}</h5>
                                        ...
                                        <td className="px-4 py-4 text-center">
                                            {item.foto ? (
                                                <div className="relative h-10 w-10 mx-auto rounded-md overflow-hidden border-2 border-white dark:border-boxdark shadow-sm bg-gray-200">
                                                    <Image
...
export default withPermission(LaporanSafetyPage, { permissions: ['safety.index'] });
