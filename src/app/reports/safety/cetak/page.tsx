...
function CetakLaporanSafetyContent() {
                ...
                <div id="print-area">
                    ...
                    <div className="flex mb-8 border-b-2 border-gray-800 pb-6 items-center justify-between">
                        ...
                        <div className="text-right">
                            <h2 className="text-xl font-bold text-blue-800 uppercase tracking-widest bg-blue-50 px-4 py-1 rounded-full border border-blue-200 inline-block">Safety Briefing</h2>
                    ...
                    <div className="mb-6">
                        <h3 className="text-lg font-bold text-gray-900 mb-1">Riwayat Safety Briefing</h3>
                    ...
                    <table className="w-full text-xs text-left align-middle border-collapse border border-gray-300">
                        <thead className="bg-gray-100 text-gray-900 border-b-2 border-gray-400">
                            <tr>
                                ...
                                <th className="px-3 py-2 border border-gray-300 w-[15%] font-semibold">Waktu & Shift</th>
                                <th className="px-3 py-2 border border-gray-300 w-[20%] font-semibold">Pemateri / Karyawan</th>
                                <th className="px-3 py-2 border border-gray-300 w-[45%] font-semibold">Keterangan / Materi</th>
                                ...
                                <tr key={item.id} className={key % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                                    ...
                                    <td className="px-3 py-3 border border-gray-300 my-no-break align-top">
                                        <div className="font-semibold text-gray-900 whitespace-nowrap">
                                            {item.tanggal_jam ? new Date(item.tanggal_jam).toLocaleDateString('id-ID', { day: '2-digit', month: 'short', year: 'numeric' }) : '-'}
                                        </div>
                                        <div className="text-[10px] text-gray-600 font-mono tracking-tighter whitespace-nowrap mt-0.5">
                                            {item.tanggal_jam ? new Date(item.tanggal_jam).toLocaleTimeString('id-ID', { hour: '2-digit', minute: '2-digit' }) : ''}
                                        </div>
                                        <div className="mt-1 text-xs font-medium text-blue-700 bg-blue-50 w-fit px-1.5 py-0.5 rounded border border-blue-100">
                                            {item.nama_shift || '-'}
                                        </div>
                                    </td>
                                    <td className="px-3 py-3 border border-gray-300 my-no-break align-top">
                                        <div className="font-bold text-gray-900 leading-tight">{item.nama_karyawan}</div>
                                        <div className="text-[10px] text-gray-500 font-mono mt-0.5">{item.nik}</div>
                                    </td>
                                    <td className="px-3 py-3 border border-gray-300 my-no-break align-top">
                                        ...
                                        {item.foto ? (
                                            <div className="flex justify-center">
                                                <img
                                                    ...
                                                    alt="Bukti Briefing"
                                                    className="w-20 h-20 object-contain bg-gray-100 border border-gray-200 rounded p-1 shadow-sm"
