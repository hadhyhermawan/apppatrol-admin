        ...
        <MainLayout>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                ...
                <div className="border-b border-gray-200 dark:border-gray-800">
                    <nav className="flex gap-2 px-6 pt-6" aria-label="Tabs">
                        {[
                            { key: 'absen' as const, label: 'Izin Absen', icon: FileText },
                            { key: 'sakit' as const, label: 'Izin Sakit', icon: FileText },
                            { key: 'cuti' as const, label: 'Izin Cuti', icon: FileText },
                            { key: 'dinas' as const, label: 'Izin Dinas', icon: FileText }
                        ].map(tab => (
                            <button
                                key={tab.key}
                                onClick={() => {
                                ...
                                className={`flex items-center gap-2 px-4 py-3 font-medium text-sm rounded-t-lg transition-colors ${activeTab === tab.key
