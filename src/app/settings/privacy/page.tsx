...
export default function PrivacyPage() {
    ...
    return (
        <MainLayout>
            <PageBreadcrumb pageTitle="Kebijakan Privasi" />
                ...
                <div className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                    <div>
                        ...
                        <p className="mt-1 text-sm text-gray-500">
                            Hanya 1 (satu) dokumen privasi yang dapat berstatus <strong className="text-green-600">Aktif</strong>.
                        </p>
                    </div>
                    ...
                    <table className="w-full table-auto">
                        ...
                        <tbody>
                            {loading ? (
                                ...
                                <tr><td colSpan={4} className="px-4 py-8 text-center text-gray-500">Belum ada data Kebijakan Privasi.</td></tr>
                            ) : (
                                data.map((item, idx) => (
