...
export default function EditAccountDeletionPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            await apiClient.put(`/account-deletion/${id}`, formData);
            Swal.fire({
                title: 'Berhasil!',
    ...
    return (
        <MainLayout>
            <PageBreadcrumb pageTitle="Edit Kebijakan Penghapusan Akun" />
